            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th style="font-size: 14px;">Test Taken</th>
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td style="font-size: 16px;">{{ $user->id }}</td>
                        <td style="font-size: 16px;">{{ $user->first_name }} {{ $user->last_name }}</td>

                  
                        <td style="font-size: 16px;">{{ $user->email }}</td>
                        
                        <td style="font-size: 16px;">{{ $user->tests->count() }}</td>
                       
                        <td style="font-size: 16px;">
                         
                            {{ $user->created_at->timezone('Asia/Manila')->format('F j, Y g:i A') }}
